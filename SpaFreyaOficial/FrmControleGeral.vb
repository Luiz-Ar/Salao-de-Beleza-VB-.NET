Public Class FrmControleGeral
    ...
    Private Sub BtnCadastrarCargo_Click(sender As Object, e As EventArgs) Handles BtnCadastrarCargo.Click
        Try
            ...
            Else
                sql = "SELECT * FROM TBCARGOS WHERE CARGO = '" & TxtCargo.Text & "'"
                rs = db.Execute(sql)
                If rs.EOF Then
                    ...
                    LimparCargo()
                Else
                    MsgBox("Cargo já cadastrado!", MsgBoxStyle.OkOnly + MsgBoxStyle.Critical, "ATENÇÃO")
                    LimparCargo()
                    TxtCargo.Select()
                End If
            End If
        Catch ex As Exception
            MsgBox("Cargo NÃO cadastrado!", MsgBoxStyle.Critical + MsgBoxStyle.Critical, "ATENÇÃO")
            LimparCargo()
        End Try
    End Sub
    ...
    Private Sub BtnCadastrarFuncionarios_Click(sender As Object, e As EventArgs) Handles BtnCadastrarFuncionarios.Click
        Try
            ...
            End If
        Catch ex As Exception
            MsgBox("Funcionário não foi cadastrado!", MsgBoxStyle.Critical + MsgBoxStyle.Critical, "ATENÇÃO")
            LimparFuncionarios()
        End Try
    End Sub
    ...
    Private Sub BtnCadastrarTipoServico_Click(sender As Object, e As EventArgs) Handles BtnCadastrarTipoServico.Click
        Try
            If TxtIdTipoServico.Text = "" Or TxtTipoServico.Text = "" Then
                MsgBox("Preencha todos os campos!", MsgBoxStyle.Critical + MsgBoxStyle.OkOnly, "ATENÇÃO")
            Else
                sql = "SELECT * FROM TBTIPOSERVICO WHERE TIPOSERVICO = '" & TxtTipoServico.Text & "'"
                rs = db.Execute(sql)
                If rs.EOF Then
                ...
                Else
                    MsgBox("Tipo de serviço já cadastrado!", MsgBoxStyle.Critical + MsgBoxStyle.OkOnly, "ATENÇÃO")
                    LimparTipoServico()
                    TxtTipoServico.Select()
                End If
            End If
    ...
    Private Sub BtnCadastrarServico_Click(sender As Object, e As EventArgs) Handles BtnCadastrarServico.Click
        Try
            ...
            End If
        Catch ex As Exception
            MsgBox("Serviço não cadastrado!", MsgBoxStyle.Critical + MsgBoxStyle.OkOnly, "ATENÇÃO")
            LimparServico()
        End Try
    End Sub
