Public Class FrmMain
    ...
    Private Sub LblCadastrarClientes_Click(sender As Object, e As EventArgs) Handles LblCadastrarClientes.Click
        ShowFormCliente()
    End Sub

    Private Sub BtnCadastrarClientes_Click(sender As Object, e As EventArgs) Handles BtnCadastrarClientes.Click
        ShowFormCliente()
    End Sub
    ...
    Private Sub BtnCadastrarCEP_Click(sender As Object, e As EventArgs) 
        ShowFormCep()
    End Sub
    ...
    Private Sub LblCadastrarCEP_Click(sender As Object, e As EventArgs) 
        ShowFormCep()
    End Sub
    ...
    Private Sub SelectCabeleireiroF()
        ...
        Me.PicTitle.BackgroundImage = Global.SpaFreyaOficial.My.Resources.Resources.titleCF
        If CF = False Then
    ...
    Private Sub SelectCabeleireiroM()
        PnlPositionActive.Visible = True
        Me.PicTitle.BackgroundImage = Global.SpaFreyaOficial.My.Resources.Resources.titleCM
        If CM = False Then
            DgvAgenda.Columns.Clear()
        End If
        CF = False
    ...
    Private Sub SelectManPed()
        PnlPositionActive.Visible = True
        Me.PicTitle.BackgroundImage = Global.SpaFreyaOficial.My.Resources.Resources.TitleMP
        If MP = False Then
            DgvAgenda.Columns.Clear()
        End If
        CF = False
    ...
    Private Sub SelectMaquiagem()
        PnlPositionActive.Visible = True
        Me.PicTitle.BackgroundImage = Global.SpaFreyaOficial.My.Resources.Resources.titleMQ
        If MQ = False Then
            DgvAgenda.Columns.Clear()
        End If
        CF = False
    ...
    Private Sub SelectMassagem()
        PnlPositionActive.Visible = True
        Me.PicTitle.BackgroundImage = Global.SpaFreyaOficial.My.Resources.Resources.titleMS
        If ES = False Then
            DgvAgenda.Columns.Clear()
        End If
        CF = False
    ...
    Private Sub SelectEstetica()
        PnlPositionActive.Visible = True
        Me.PicTitle.BackgroundImage = Global.SpaFreyaOficial.My.Resources.Resources.titleES
        If ES = False Then
            DgvAgenda.Columns.Clear()
        End If
        CF = False
    ...
    Public Sub LoadAgenda()
        ...
        agendar = New DataGridViewImageColumn With {
            ...
            .Name = "Agendar",
            .HeaderText = "Agendar",
            .Image = Global.SpaFreyaOficial.My.Resources.Resources.agenda
            }
        ...
        sql = "SELECT * FROM TBAGENDA WHERE FUNCIONARIO = '" & CmbProfissional.Text & "' AND DATASERVICO = '" & FormatDateTime(TxtData.Text, DateFormat.ShortDate) & "' AND CANCELADO = 0 ORDER BY HORARIOENTRADA ASC"
        rs = db.Execute(sql)
        With Me.DgvAgenda
            .Rows.Clear()
            If rs.EOF Then
